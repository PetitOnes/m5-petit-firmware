...
**[HOW_TO_SETUP_M5_CORES3.md](./HOW_TO_SETUP_M5_CORES3.md)** — 設定ファイル作成 → 書き込み → SDカード準備 → 動作確認までの手順です。
...
- `firmware/m5_petit/` — M5Stack CoreS3用ファームウェア(.ino)。WiFiなどの設定はSDカードの`config.txt`から読み込みます(`config.example.txt`を参照)
